...
class export_webserver(object):
    ...
    def publish(self, inverter):
        ...
        main_body = f"""
            <h3>SunGather v{__version__}</h3></p>
            <h4>Need Help? <href a='https://github.com/harrisjunaid/SunGrowInverters'>https://github.com/harrisjunaid/SunGrowInverters</a></h4></p>
            <h4>NEW HomeAssistant Add-on: <href a='https://github.com/bohdan-s/hassio-repository'>https://github.com/harrisjunaid/SunGrowInverters</a></h4></p>
            """
